...
object NavTransitions {
    ...
    /**
     * 默认动画：水平滑动
     * 优化：减少动画时长从 300ms 到 200ms，提升响应速度
     */
    val Default = TransitionConfig(
        ...
        popEnter = { slideInHorizontally(initialOffsetX = { -it }, animationSpec = tween(200)) },
        popExit = { slideOutHorizontally(targetOffsetX = { it }, animationSpec = tween(200)) }
    )
